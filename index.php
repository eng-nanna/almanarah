...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Elmanara Hospital | Welcome</title>
  ...
  <body>
    ...
    <section class="introContainer">
      <div class="introSlider">
		    <?php
			$query="SELECT * FROM uploads where gallery = 'slider'";
			$result= mysqli_query($db_conn, $query) or die("Invalid query");
			while($row = mysqli_fetch_array($result)){
			?>
        		<div><img src="<?php echo "manager/images/uploads/".$row['name'];?>" alt=""></div>
		 <?php
                }
         ?>
      </div><!-- introSlider -->
    ...
    <section class="sponsorsSection">
      <h1 class="sTitle"><span>Sponsors</span></h1>
      <div class="row">
        <div class="medium-12 column">
          ...
          <?php
			...
			while($row = mysqli_fetch_array($result)){
			?>
            <li><img src="<?php echo "img/sponsors/".$row['logo'];?>" alt=""></li>
             <?php
                }
         ?>
          </ul>
