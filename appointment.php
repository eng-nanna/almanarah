...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Elmanara Hospital | Albums</title>
    ...
    <section class=" innerSection">
      <div class="row">
        ...
        <div class="medium-12 column">
          ...
          <h2 class="redDiamond-title"><span>Appointment</span></h2>
              ...
              <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
                ...
                <div class="row">
                  <div class="medium-4 columns">
                    <label>Specialty <span class="require">*</span>
                      <select name="spec">
                      <?php
						...
						?>
                        <option value="husker"><?php echo $row['name'];?></option>
                        <?php
                }
         ?>
                      </select>
                  ...
                  <div class="medium-4 columns">
                    <label>Doctor <span class="require">*</span>
                      <select name="doc">
                       <?php
         ...
         ?>
                  ...
                  <div class="medium-4 columns">
                    <label>Date <span class="require">*</span>
                      <input id="datepicker" type="text" placeholder="0000-00-00" name="date" />
                    </label>
                  </div>
                ...
                <div class="row">
                  <div class="medium-12 columns">
                    <label>Medical Record Number
                      <input type="text" placeholder="large-12.columns" name="rec_num" />
                    </label>
                  </div>

                  <div class="medium-12 columns">
                    <label>Name <span class="require">*</span>
                      <input type="text" placeholder="large-12.columns" name="patient" />
                    </label>
                  </div>

                  <div class="medium-12 columns">
                    <label>Phone Number <span class="require">*</span>
                      <input type="text" placeholder="large-12.columns" name="phone" />
                    </label>
                  </div>

                  <div class="medium-12 columns">
                    <label>Mobile Number <span class="require">*</span>
                      <input type="text" placeholder="large-12.columns" name="mobile" />
                    </label>
                  </div>

                  <div class="medium-12 columns">
                    <label>Email
                      <input type="text" placeholder="large-12.columns" name="mail" />
                    </label>
                  </div>
        ...
        if (isset($_POST['submit'])){
			...
			$record = $_POST['rec_num'];
			$name = $_POST['patient'];
			$phone = $_POST['phone'];
			$mobile = $_POST['mobile'];
			$mail = $_POST['mail'];
            /***********************************************/
            $result = mysqli_query($db_conn,"INSERT INTO appointments (Specialty,doctor,date,medical_record,name,phone_num,mobile_num,email) VALUES ('$Specialty','$dr','$newDate','$record','$name','$phone','$mobile','$mail')");
            if ($result) echo "Your reservation has been sent.";
