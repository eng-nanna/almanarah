...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Elmanara Hospital | About Us</title>
    ...
    <section class=" innerSection">
      <div class="row">
        ...
        <sidebar class="medium-4 column innerSidebar medium-push-8">
          <h4 class="redDiamond-title hide-for-small-only"><span>Find Us</span></h4>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3433.764737827642!2d32.27289671454424!3d30.61239839847439!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f8597ac1a7b461%3A0xbe8d65082f35bad6!2z2YXYs9iq2LTZgdmJINin2YTZhdmG2KfYsdipINin2YTYqtiu2LXYtdmKINio2KfZhNij2LPZhdin2LnZitmE2YrYqQ!5e0!3m2!1sen!2s!4v1451241233578" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <div class="medium-8 column medium-pull-4">
          ...
          <h2 class="redDiamond-title"><span>Contact Us</span></h2>
          ...
          <form id="contact-form" action="" method="POST" enctype="multipart/form-data">            
            ...
            <div class="row">
              <div class="medium-12 column">
                <label>Your Message
                  <textarea name="msg" placeholder="Your Message" rows="8"></textarea>
                </label>
              </div>
            </div><!-- row -->
        ...
        if (isset($_POST['submit'])){
			...
			$msg = $_POST['msg'];
            /***********************************************/
			$sql="SELECT * FROM contacts where type = 'E-Mail'";
			$result=mysqli_query($db_conn,$sql);
			$rows=mysqli_fetch_array($result);
			$admin_mail = $rows['content'];
                /*****************************************************/
           if (($name=="")||($email=="")||($title=="")||($msg=="")){
			   echo "All fields are required, please fill.";
        	}else{
				if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
        // valid address
		$from="From: $name<$email>\r\nReturn-path: $email";
        mail($admin_mail, $title, $msg, $from);
		$result = mysqli_query($db_conn,"INSERT INTO msgs (name,mail,title,msg) VALUES ('$name','$email','$title','$msg')");
            if ($result) echo "Email sent!";
