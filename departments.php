    ...
    <section class=" innerSection">
      <div class="row">
        ...
        <sidebar class="medium-4 column innerSidebar medium-push-8">
          <img src="img/manara-logo.jpg" alt="doctors" class="th">
        </sidebar><!-- innerSidebar -->

        <div class="medium-8 column medium-pull-4">

          <h2 class="redDiamond-title"><span>Departments</span></h2>
          ...
          <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="description.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
