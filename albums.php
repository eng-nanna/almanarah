    ...
    <section class=" innerSection">
      <div class="row">
        ...
        <div class="medium-12 column">
          ...
          <h2 class="redDiamond-title"><span>Albums</span></h2>
              ...
              <ul class=" small-block-grid-1 medium-block-grid-4">
                ...
                <li>
                  <div class="album-item">
                    ...
                    <a href="gallery-open.php?index=<?php echo $rows['id'];?>">
                      <div class="album-container">
                      <?php
						$sql1="SELECT * FROM uploads WHERE gallery = '$album'";
						$result1=mysqli_query($db_conn,$sql1);
						$rows1=mysqli_fetch_array($result1)
						?>

                        <div class="albumImgHolder img-1">
                          <span><img src="manager/images/uploads/<?php echo $rows1['name'];?>" style="height:190px; width:300px" alt="image preview"></span>
                        </div><!-- img-1 -->
                      ...
                      <p class="album-title">
                        <span class="date"><?php echo $rows['date']; ?></span>
                        <?php echo $rows['name']; ?>
                      </p>
                    </a>
