...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
            ...
            if ($_FILES['files']['error'] == 0) {
                if( ! in_array(pathinfo($pic, PATHINFO_EXTENSION), $valid_formats) ){
                  ...
                  if(move_uploaded_file($_FILES["files"]["tmp_name"], $path.$pic)) {
                      $result = mysqli_query($db_conn,"INSERT INTO uploads (name,title,gallery) VALUES ('$pic','$title','$gallery')");
        ...
        <?php
		$sql="SELECT * FROM uploads where gallery = '$gallery'";
        ...
        if($result){
        	echo "<meta http-equiv=\"refresh\" content=\"0;URL=gallry2.php\">";
        }
        }
