...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add event</a></li>
                            <li><a id="showdiv2">Remove events</a></li>
                            <li><a id="showdiv3">Update event</a></li>
                        </ul>
        ...
        Start Date: <input id="datepicker" type="text" name="date"> <br><br>
        End Date: <input id="datepicker1" type="text" name="date1"> <br><br>
        ...
        if (isset($_POST['add'])){
            $tit = $_POST['title'];
            $d1 = $_POST['date'];
			$newDate = date("Y-m-d", strtotime($d1));
			$d2 = $_POST['date1'];
			$newDate1 = date("Y-m-d", strtotime($d2));
            $url = $_POST['url'];
			/***********************************************/
			
            $result = mysqli_query($db_conn,"INSERT INTO events (title,start,end,url) VALUES ('$tit','$newDate','$newDate1','$url')");
            if ($result) echo "New Event has been added.";      
        }
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Event</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="events_update.php?id=<?php echo $row['id'];?>"><?php echo $row['title'];?></a></td>
              </tr>
               <?php
                }
         ?>
