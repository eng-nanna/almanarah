...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <!--<img src="../img/news/<!?php echo $row['img']; ?>"/> Image: <input type="file" name="files"> <br><br>-->
        Brief: <textarea id="desc" cols="100" rows="3" name="brief"><?php echo $row['Brief']; ?></textarea><br><br>
        Text: <textarea id="news" cols="100" rows="10" name="news" ><?php echo $row['text']; ?></textarea><br><br>
        ...
        if (isset($_POST['submit'])){
            ...
            $txt = $_POST['news'];
            /***********************************************/
			$result = mysqli_query($db_conn,"UPDATE news SET title='$tit', date='$newDate', text='$txt', Brief='$brief' where id='$id'");
            if ($result) echo "News has been updated.";
