...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="contributor.php">contributors</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add contributor</a></li>
                            <li><a id="showdiv2">Remove contributor</a></li>
                            <li><a id="showdiv3">Update contributor</a></li>
                        </ul>
        ...
        contributor Name: <input type="text" name="name"> <br><br>
        Phone number: <input type="text" name="phone"> <br><br>
        Email: <input type="mail" name="mail"> <br><br>
        image: <input type="file" name="files"> <br><br>
        Description: <textarea id="desc" name="desc" cols="75" rows="8"></textarea><br /><br />
        ...
        $max_file_dim = 200;
        $path = "images/contributor/"; // Upload directory
		/*****************************************************/
        if (isset($_POST['submit'])){
            ...
            if ($_FILES['files']['error'] == 0) {
				...
				// valid address
				 $result = mysqli_query($db_conn,"INSERT INTO contributor (name,img,phone,mail,description) VALUES ('$cont','$pic','$phone','$email','$desc')");
					if ($result) echo "New contributor has been added.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete contributor</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        $sql = "DELETE FROM contributor WHERE id='$del_id'";
        $result = mysqli_query($db_conn,$sql);
        }
        // if successful redirect to delete_multiple.php
        if($result)
        {
        echo "<meta http-equiv=\"refresh\" content=\"0;URL=contributor.php\">";
        }
        }
        ?>
        </table>
        ...
        <!-- Departments Table -->
          <table width="100%">
            <thead>
              <tr>
                <td width="5%">No</td>
                <td width="95%">contributor Name</td>
              </tr>
            </thead>
            <tbody>
            <?php
			...
			?>
              <tr>
                ...
                <td><a href="cont_update.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
