...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="contacts.php">Contacts</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add New Contact</a></li>
                            <li><a id="showdiv2" >Remove Contact</a></li>
                        </ul>
        ...
        if (isset($_POST['submit'])){
            ...
            $txt = $_POST['content'];
            /***********************************************/
            $result = mysqli_query($db_conn,"INSERT INTO contacts (type,content) VALUES ('$type','$txt')");
            if ($result) echo "New contact has been added.";
