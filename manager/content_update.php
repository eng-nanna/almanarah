...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        Text: <textarea id="txt" cols="100" rows="10" name="news" ><?php echo $row['text']; ?></textarea><br><br>
        ...
        if (isset($_POST['submit'])){
            $tit = $_POST['title'];
            $txt = mysqli_real_escape_string($db_conn,$_POST['news']);
            /***********************************************/
			$result = mysqli_query($db_conn,"UPDATE about_us SET title='$tit', text='$txt' where id='$id'");
            if ($result) echo "Content has been updated.";
