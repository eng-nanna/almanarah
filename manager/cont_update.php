...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        contributor Name: <input type="text" name="title" value="<?php echo $row['name']; ?>"> <br><br>
        Phone Number: <input type="text" name="phone" value="<?php echo $row['phone']; ?>"> <br><br>
        Email: <input type="mail" name="mail" value="<?php echo $row['mail']; ?>"> <br><br>
        Description: <textarea id="desc" cols="100" rows="3" name="brief"><?php echo $row['description']; ?></textarea><br><br>
		...
		<?php
		 if (isset($_POST['submit'])){
			...
			$mail = $_POST['mail'];
            /***********************************************/
			$result = mysqli_query($db_conn,"UPDATE contributor SET name='$name', description='$desc', phone='$phone', mail='$mail' where id='$id'");
            if ($result) echo "contributor has been updated.";
