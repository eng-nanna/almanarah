...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="gallery.php">Gallery</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Create Album</a></li>
                            <li><a id="showdiv2">Remove Album</a></li>
                            <li><a id="showdiv3">View Albums</a></li>
        ...
        Album name: <input type="text" name="name"> <br><br>
        Date: <input type="text" name="date"> <br><br>
        Descrption: <textarea id="desc" name="desc" cols="100" rows="5"></textarea> <br><br>
		...
		if (isset($_POST['submit'])){
            ...
            $date = $_POST['date'];
			$desc = $_POST['desc'];
        $result = mysqli_query($db_conn,"INSERT INTO gallery (name,date,description) VALUES ('$name','$date','$desc')");
            if ($result) echo "New Album has been created.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Album</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="gallery2.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
