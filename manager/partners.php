...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="partners.php">Partners</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add Partner</a></li>
                            <li><a id="showdiv2">Remove Partner</a></li>
                        </ul>
        ...
        Partner Name: <input type="text" name="name"> <br><br>
        Logo: <input type="file" name="files"> <br><br>
        ...
        $path = "../img/sponsors/"; // Upload directory
            ...
            if ($_FILES['files']['error'] == 0) {
                if( ! in_array(pathinfo($pic, PATHINFO_EXTENSION), $valid_formats) ){
                  ...
                  if(move_uploaded_file($_FILES["files"]["tmp_name"], $path.$pic)) {
                      $result = mysqli_query($db_conn,"INSERT INTO partners (name,logo) VALUES ('$name','$pic')");
                  if ($result) echo "New Partner has been added";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Partner</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        <td><img src="../img/sponsors/<?php echo $rows['logo']; ?>" height="60" width="100" /></td>
        </tr>
		...
		unlink($img);
        $sql = "DELETE FROM partners WHERE id='$del_id'";
        $result = mysqli_query($db_conn,$sql);
        }
        if($result){
