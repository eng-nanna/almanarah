...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add Doctor</a></li>
                            <li><a id="showdiv2">Remove Doctor</a></li>
                            <li><a id="showdiv3">Doctors profiles</a></li>
                        </ul>
        ...
        Profile picture: <input type="file" name="files"> <br><br>
        Bio: <textarea id="desc" name="desc" cols="75" rows="8"></textarea><br /><br />
        ...
        Facebook account URL: <input type="text" name="facebook"> <br><br>
        Twitter account URL: <input type="text" name="twitter"> <br><br>
        ...
        $max_file_dim = 200;
        $path = "../img/doctors/"; // Upload directory
		/*****************************************************/
        if (isset($_POST['submit'])){
            ...
            if ($_FILES['files']['error'] == 0) {
				...
				// valid address
				 $result = mysqli_query($db_conn,"INSERT INTO doctors (name,description,departments,specialty,profile_pic,mail,facebook,twitter) VALUES ('$dr','$desc','$dept','$special','$pic','$email','$fb','$twtr')");
					if ($result) echo "New Doctor has been added.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Doctors</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        <td><?php echo $rows['departments']; ?></td>
          ...
          <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="doc_update.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
