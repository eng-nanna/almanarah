...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="inbox.php">Inbox</a></li>
        ...
        <?php if($rows['flag'] == 0){ ?>
        <td><a href="msg.php?id=<?php echo $rows['id'];?>"><strong><?php echo $rows['title']; ?></strong></a></td>
        <?php }else{ ?>
        <td><a href="msg.php?id=<?php echo $rows['id'];?>"><?php echo $rows['title']; ?></a></td>
        <?php } ?>
        </tr>
