...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        Start Date: <input id="datepicker" type="text" name="date" value="<?php echo $row['start']; ?>"> <br><br>
        End Date: <input id="datepicker1" type="text" name="date1" value="<?php echo $row['end']; ?>"> <br><br>
        ...
        if (isset($_POST['submit'])){
            ...
            $url = $_POST['url'];
			$result = mysqli_query($db_conn,"UPDATE events SET title='$tit', start='$newDate', end='$newDate1', url='$url' where id='$id'");
            if ($result) echo "Event has been updated.";
