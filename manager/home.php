...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="header-main">
                <div class="container_13">
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                <li id="current"><a href="home.php">Departments</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add departments</a></li>
                            <li><a id="showdiv2">Remove department</a></li>
                            <li><a id="showdiv3">Update department</a></li>
                      </ul>
        ...
        Department name: <input type="text" name="name"> <br><br>
        Description: <textarea id="desc" cols="100" rows="6" name="desc"></textarea> <br><br>
        ...
        if (isset($_POST['submit'])){
            ...
            $result = mysqli_query($db_conn,"INSERT INTO dept (name, description,pic) VALUES ('$dept_name','$desc','$pic')");
            if ($result) echo "New department has been added.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Departments</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        $sql = "DELETE FROM dept WHERE id='$del_id'";
        $result = mysqli_query($db_conn,$sql);
        }
          ...
          <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="dept_update.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
