...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
                    ...
                    <div class="grid_13">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="specialty.php">specialties</a></li>
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add specialty</a></li>
                            <li><a id="showdiv2">Remove specialty</a></li>
                      </ul>
        ...
        Specialty: <input type="text" name="name"> <br><br>
        ...
        if (isset($_POST['submit'])){
            ...
            $result = mysqli_query($db_conn,"INSERT INTO specialty (name) VALUES ('$name')");
            if ($result) echo "New specialty has been added.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Specialty</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        $sql = "DELETE FROM specialty WHERE id='$del_id'";
        $result = mysqli_query($db_conn,$sql);
        }
        // if successful redirect to delete_multiple.php
        if($result)
        {
        echo "<meta http-equiv=\"refresh\" content=\"0;URL=specialty.php\">";
        }
        }
        ?>
        </table>
