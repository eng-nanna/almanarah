...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        Department: <input type="text" name="title" value="<?php echo $row['name']; ?>"> <br><br>
		...
		<?php
		 if (isset($_POST['submit'])){
			...
			$desc = $_POST['brief'];
            /***********************************************/
			$result = mysqli_query($db_conn,"UPDATE dept SET name='$name', description='$desc' where id='$id'");
            if ($result) echo "Department has been updated.";
