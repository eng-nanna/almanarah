...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a id="showdiv1">Add Admin</a></li>
                            <li><a id="showdiv2" >Remove Admins</a></li>
                            <li><a id="showdiv3">Update Admin Pofile</a></li>
                        </ul>
        ...
        if (isset($_POST['submit'])){
            ...
            /***********************************************/
            $result = mysqli_query($db_conn,"INSERT INTO admins (name,password) VALUES ('$username','$password')");
            if ($result) echo "New admin has been added.";
        ...
        <tr>
        <td>&nbsp;</td>
        <td colspan="4"><h1>Delete Administrators</h1> </td>
        </tr>
        <tr><td></td></tr>
        <tr>
        ...
        $sql = "DELETE FROM admins WHERE id='$del_id'";
        $result = mysqli_query($db_conn,$sql);
        }
          ...
          <table width="100%">
			...
			?>
              <tr>
                ...
                <td><a href="admin_update.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
              </tr>
               <?php
                }
         ?>
