...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Elmanara Hospital | News</title>
  ...
  <body>
    ...
    <section class="introContainer innerPages">
      <div class="innerPageImage">
        <img src="img/about_us.jpg" alt="News">      
      </div><!-- innerPageImage -->
    ...
    <section class=" innerSection">
      <div class="row">
        ...
        <div class="medium-12 column ">
          ...
          <h2 class="redDiamond-title"><span>News</span></h2>
          ...
          <ul class="medium-block-grid-2 large-block-grid-4">
            ...
            <li>
                <div class="news-item">
                  ...
                  <div class="news-img">
                    <div class="news-date">
                      <span><?php echo date('d', $time);?></span> <?php echo date('F', $time);?>
                    </div><!-- news-date -->
                    <img src="img/news/<?php echo $row['img'];?>" alt="news image doctor" width="300" height="300">
                  </div><!-- news-img -->
                  ...
                  <div class="news-more">
                    <a class="button expand" href="news-open.php?id=<?php echo $row['id'];?>">Read More</a>
                  </div><!-- news-more -->
		 ...
		 echo "<a href='news.php?page=1'>".'|<'."</a> "; // Goto 1st page
		 
		 for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='news.php?page=".$i."'>".$i."</a> "; 
			}
			echo "<a href='news.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
			?>  
...
<!--
        <sidebar class="medium-4 column innerSidebar">
          <h4 class="redDiamond-title"><span>Find Us</span></h4>
          <iframe id="findUsMap" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d6867.68081559021!2d32.28535215811232!3d30.610264396871756!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sar!2seg!4v1435219851786"  frameborder="0" style="border:0" allowfullscreen></iframe>
          <p>
